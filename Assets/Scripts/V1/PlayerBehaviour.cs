...
namespace Assets.Scripts.V1
{
    public class PlayerBehaviour : MonoBehaviour {
        ...
        Tile.Tile CheckForPerpendicularTile ()
        {
            RaycastHit hit;
            ...
            if (Physics.Raycast (downCheck.position, direction, out hit, distance)) {
                t = hit.collider.gameObject.GetComponent<Tile.Tile> ();
            }
            return t;
        }
        ...
        Tile.Tile GetTileBelow ()
        {
            ...
            if(Physics.Raycast(transform.position, direction, out hit, distance)){
                tile = hit.collider.gameObject.GetComponent<Tile.Tile> ();
            }
